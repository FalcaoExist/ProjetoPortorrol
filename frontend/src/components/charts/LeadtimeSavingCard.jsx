...
export default function LeadtimeSavingCard({ leadtime = null, saving = 8 }) {
  ...
  return (
    <div className="border border-[#e5e5e5] rounded-xl p-4 flex flex-col items-center justify-center shadow-sm bg-white w-full min-w-0 h-full">
      <span className="text-md md:text-lg text-[#464255] font-poppins">Leadtime médio</span>
      <span className="text-xl md:text-3xl font-bold text-[#2d253b] font-poppins leading-tight">{displayLeadtime} {leadtime === null ? '' : 'dias'}</span>
